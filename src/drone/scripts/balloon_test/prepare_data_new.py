...
classes = ['bed', 'chair', 'table', 'pillow', 'sofa', 'tv', 'laptop', 'mural', 'lamp']
...
# yolov5_images_train_dir = 到train目录的路径
...
# yolov5_images_val_dir = 到val目录的路径
...
# yolov5_images_test_dir = 到test目录的路径
...
# yolov5_labels_val_dir = 到val目录的路径
...
# yolov5_labels_test_dir = 到test目录的路径
