...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_drones',  default=6,                 type=int,                                                                 help='Number of drones (default: 2)', metavar='')
    parser.add_argument('--env',         default='flock',  type=str,             choices=['leaderfollower', 'flock', 'meetup'],      help='Task (default: leaderfollower)', metavar='')
    ...
    config["multiagent"] = { 
        "policies": {
            ...
            "pol4": (None, observer_space, action_space, {"agent_id": 4,}),
            "pol5": (None, observer_space, action_space, {"agent_id": 5,}),
        },
        "policy_mapping_fn": lambda x: "pol"+str(x) ,#if x == 0 else "pol1" # # Function mapping agent ids to policy ids
