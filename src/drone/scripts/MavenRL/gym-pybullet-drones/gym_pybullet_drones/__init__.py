...
register(
    id='formation_containment-v0',
    entry_point='gym_pybullet_drones.envs.multi_agent_rl:Formation_containment',
)
register(
    id='formation_containment_2order-v0',
    entry_point='gym_pybullet_drones.envs.multi_agent_rl:Formation_containment_2order',
)