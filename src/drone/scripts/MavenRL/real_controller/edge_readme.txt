...
cd ~/5g-ws/src/drone/scripts/balloon_test
python detect_balloon.py
...
cd  ~/5g-ws
roslaunch balloon_estimation balloon_estimation.launch
...
#Note:check the loaded model,  
cd ~/5g-ws/src/drone/scripts/MavenRL/real_controller
python teamrl_controller_explore.py
...
cd ~/5g-ws/src/drone/scripts/MavenRL/real_controller
python teamrl_controller_obs_avoid.py
