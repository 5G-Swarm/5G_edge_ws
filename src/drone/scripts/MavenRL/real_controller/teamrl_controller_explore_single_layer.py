...
def main(episodes):
	...
	while not rospy.is_shutdown():
		...
		controlvxy_dict = real_env._preprocessAction(axay_dict,kp=30)#30#5#15###90
		print("axay_dict:",axay_dict)
		print("controlvxy_dict:",controlvxy_dict)	
		###z_controler###	
