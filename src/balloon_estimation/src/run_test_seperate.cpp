...
ros::Publisher uav_pose_0_pub,uav_pose_1_pub,uav_pose_2_pub,uav_pose_3_pub,uav_pose_4_pub,uav_pose_5_pub,uav_pose_6_pub,uav_pose_7_pub,uav_pose_8_pub,uav_pose_9_pub;
ros::Publisher uav_imu_pose_0_pub,uav_imu_pose_1_pub,uav_imu_pose_2_pub,uav_imu_pose_3_pub,uav_imu_pose_4_pub,uav_imu_pose_5_pub,uav_imu_pose_6_pub,uav_imu_pose_7_pub,uav_imu_pose_8_pub,uav_imu_pose_9_pub;


void UAV_callback_0(const autoware_msgs::DroneSyn::ConstPtr &msg, int id)
{
    ...
    uav_pose_0_pub.publish(pose);
    std::cout<<"timestamp: "<<std::to_string(pose.header.stamp.toSec())<<std::endl;
    ...
    uav_imu_pose_0_pub.publish(pose);
...
void UAV_callback_1(const autoware_msgs::DroneSyn::ConstPtr &msg, int id)
{
    ...
    pose.pose.position.z = position_IMU.z();
    // pubs_imu[id].publish(pose);
    uav_imu_pose_1_pub.publish(pose);
...
void UAV_callback_2(const autoware_msgs::DroneSyn::ConstPtr &msg, int id)
{
    ...
    pose.pose.position.z = position_IMU.z();
    // pubs_imu[id].publish(pose);
    uav_imu_pose_2_pub.publish(pose);
...
void UAV_callback_3(const autoware_msgs::DroneSyn::ConstPtr &msg, int id)
{
    ...
    pose.pose.position.z = position_IMU.z();
    // pubs_imu[id].publish(pose);
    uav_imu_pose_3_pub.publish(pose);
...
void UAV_callback_4(const autoware_msgs::DroneSyn::ConstPtr &msg, int id)
{
    ...
    pose.pose.position.z = position_IMU.z();
    // pubs_imu[id].publish(pose);
    uav_imu_pose_4_pub.publish(pose);
...
void UAV_callback_5(const autoware_msgs::DroneSyn::ConstPtr &msg, int id)
{
    ...
    pose.pose.position.z = position_IMU.z();
    // pubs_imu[id].publish(pose);
    uav_imu_pose_5_pub.publish(pose);
...
void UAV_callback_6(const autoware_msgs::DroneSyn::ConstPtr &msg, int id)
{
    ...
    pose.pose.position.z = position_IMU.z();
    // pubs_imu[id].publish(pose);
    uav_imu_pose_6_pub.publish(pose);
...
void UAV_callback_7(const autoware_msgs::DroneSyn::ConstPtr &msg, int id)
{
    ...
    pose.pose.position.z = position_IMU.z();
    // pubs_imu[id].publish(pose);
    uav_imu_pose_7_pub.publish(pose);
...
void UAV_callback_8(const autoware_msgs::DroneSyn::ConstPtr &msg, int id)
{
    ...
    pose.pose.position.z = position_IMU.z();
    // pubs_imu[id].publish(pose);
    uav_imu_pose_8_pub.publish(pose);
...
void UAV_callback_9(const autoware_msgs::DroneSyn::ConstPtr &msg, int id)
{
   ...
   // pubs[id].publish(pose);
    ...
    pose.pose.position.z = position_IMU.z();
    // pubs_imu[id].publish(pose);
    uav_imu_pose_9_pub.publish(pose);
...
void bb_callback(const geometry_msgs::PoseStamped::ConstPtr &msg, int id)
{
    ...
    std::cout<<"bbx timestamp: "<<std::to_string(msg->header.stamp.toSec())<<std::endl;
...
int main(int argc, char** argv)
{
  ...
  uav_pose_0_pub = nh.advertise<geometry_msgs::PoseStamped>("/uav_0",20);
  
  uav_imu_pose_0_pub = nh.advertise<geometry_msgs::PoseStamped>("/uav_0_imu",20);
  
  uav_pose_1_pub = nh.advertise<geometry_msgs::PoseStamped>("/uav_1",20);
  
  uav_imu_pose_1_pub = nh.advertise<geometry_msgs::PoseStamped>("/uav_1_imu",20);
  
  uav_pose_2_pub = nh.advertise<geometry_msgs::PoseStamped>("/uav_2",20);
  
  uav_imu_pose_2_pub = nh.advertise<geometry_msgs::PoseStamped>("/uav_2_imu",20);
  
  uav_pose_3_pub = nh.advertise<geometry_msgs::PoseStamped>("/uav_3",20);
  
  uav_imu_pose_3_pub = nh.advertise<geometry_msgs::PoseStamped>("/uav_3_imu",20);
  
  uav_pose_4_pub = nh.advertise<geometry_msgs::PoseStamped>("/uav_4",20);
  
  uav_imu_pose_4_pub = nh.advertise<geometry_msgs::PoseStamped>("/uav_4_imu",20);
  
  uav_pose_5_pub = nh.advertise<geometry_msgs::PoseStamped>("/uav_5",20);
  
  uav_imu_pose_5_pub = nh.advertise<geometry_msgs::PoseStamped>("/uav_5_imu",20);
  
  uav_pose_6_pub = nh.advertise<geometry_msgs::PoseStamped>("/uav_6",20);
  
  uav_imu_pose_6_pub = nh.advertise<geometry_msgs::PoseStamped>("/uav_6_imu",20);
  
  uav_pose_7_pub = nh.advertise<geometry_msgs::PoseStamped>("/uav_7",20);
  
  uav_imu_pose_7_pub = nh.advertise<geometry_msgs::PoseStamped>("/uav_7_imu",20);
  
  uav_pose_8_pub = nh.advertise<geometry_msgs::PoseStamped>("/uav_8",20);
  
  uav_imu_pose_8_pub = nh.advertise<geometry_msgs::PoseStamped>("/uav_8_imu",20);
  
  uav_pose_9_pub = nh.advertise<geometry_msgs::PoseStamped>("/uav_9",20);
  
  uav_imu_pose_9_pub = nh.advertise<geometry_msgs::PoseStamped>("/uav_9_imu",20);
  

  ros::Subscriber uav_0_sub = nh.subscribe<autoware_msgs::DroneSyn>("/drone_state_0", 20, boost::bind(&UAV_callback_0,_1,0));
  ros::Subscriber uav_1_sub = nh.subscribe<autoware_msgs::DroneSyn>("/drone_state_1", 20, boost::bind(&UAV_callback_1,_1,1));
  ros::Subscriber uav_2_sub = nh.subscribe<autoware_msgs::DroneSyn>("/drone_state_2", 20, boost::bind(&UAV_callback_2,_1,2));
  ros::Subscriber uav_3_sub = nh.subscribe<autoware_msgs::DroneSyn>("/drone_state_3", 20, boost::bind(&UAV_callback_3,_1,3));
  ros::Subscriber uav_4_sub = nh.subscribe<autoware_msgs::DroneSyn>("/drone_state_4", 20, boost::bind(&UAV_callback_4,_1,4));
  ros::Subscriber uav_5_sub = nh.subscribe<autoware_msgs::DroneSyn>("/drone_state_5", 20, boost::bind(&UAV_callback_5,_1,5));
  ros::Subscriber uav_6_sub = nh.subscribe<autoware_msgs::DroneSyn>("/drone_state_6", 20, boost::bind(&UAV_callback_6,_1,6));
  ros::Subscriber uav_7_sub = nh.subscribe<autoware_msgs::DroneSyn>("/drone_state_7", 20, boost::bind(&UAV_callback_7,_1,7));
  ros::Subscriber uav_8_sub = nh.subscribe<autoware_msgs::DroneSyn>("/drone_state_8", 20, boost::bind(&UAV_callback_8,_1,8));
  ros::Subscriber uav_9_sub = nh.subscribe<autoware_msgs::DroneSyn>("/drone_state_9", 20, boost::bind(&UAV_callback_9,_1,9));

  ros::Subscriber bb_0_sub = nh.subscribe<geometry_msgs::PoseStamped>("/target_bbx_0", 20, boost::bind(&bb_callback,_1,0));
  ros::Subscriber bb_1_sub = nh.subscribe<geometry_msgs::PoseStamped>("/target_bbx_1", 20, boost::bind(&bb_callback,_1,1));
  ros::Subscriber bb_2_sub = nh.subscribe<geometry_msgs::PoseStamped>("/target_bbx_2", 20, boost::bind(&bb_callback,_1,2));
  ros::Subscriber bb_3_sub = nh.subscribe<geometry_msgs::PoseStamped>("/target_bbx_3", 20, boost::bind(&bb_callback,_1,3));
  ros::Subscriber bb_4_sub = nh.subscribe<geometry_msgs::PoseStamped>("/target_bbx_4", 20, boost::bind(&bb_callback,_1,4));
  ros::Subscriber bb_5_sub = nh.subscribe<geometry_msgs::PoseStamped>("/target_bbx_5", 20, boost::bind(&bb_callback,_1,5));
  ros::Subscriber bb_6_sub = nh.subscribe<geometry_msgs::PoseStamped>("/target_bbx_6", 20, boost::bind(&bb_callback,_1,6));
  ros::Subscriber bb_7_sub = nh.subscribe<geometry_msgs::PoseStamped>("/target_bbx_7", 20, boost::bind(&bb_callback,_1,7));
  // ros::Subscriber bb_8_sub = nh.subscribe<geometry_msgs::PoseStamped>("/target_bbx_8, 1, boost::bind(&bb_callback,_1,rostopi));
  ros::Subscriber bb_8_sub = nh.subscribe<geometry_msgs::PoseStamped>("/target_bbx_8", 20, boost::bind(&bb_callback,_1,8));
  ros::Subscriber bb_9_sub = nh.subscribe<geometry_msgs::PoseStamped>("/target_bbx_9", 20, boost::bind(&bb_callback,_1,9));
  ...
  while(ros::ok())
  {
    ...
    if(!bb_buf.empty())
    {
      ...
      if(update)
      {
        ...
        cout<<"processing time: "<<to_string(time_end-time_begin)<<endl;
      }
    }
