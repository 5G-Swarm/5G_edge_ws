...
class TrackingObjectMarker {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type TrackingObjectMarker
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type TrackingObjectMarker
    let len;
    let data = new TrackingObjectMarker(null);
  ...
  static datatype() {
    ...
    return 'autoware_msgs/TrackingObjectMarker';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '2da1987f4232f3b3d525063c577dacc3';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TrackingObjectMarker(null);
...
module.exports = TrackingObjectMarker;
